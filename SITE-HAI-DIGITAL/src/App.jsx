          ...
          <div className='lg:px-[80px] px-[60px]'>
            <div className='lg:flex justify-between pb-7 cursor-pointer border-b-[1px]'>
                ...
                <div className="flex lg:mt-0 mt-7 flex-col w-[350px] text-white items-start gap-2">
                  ...
                  <p className="text-sm lg:mt-3 mt-4"><span className='text-[25px] font-semibold'>HAI DIGITAL --</span><br/> l’intelligence numérique au service d’un avenir durable, s’engage à créer des solutions innovantes qui allient technologie et responsabilité. </p>
                </div>
