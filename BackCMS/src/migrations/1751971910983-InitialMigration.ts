...
export class InitialMigration1751971910983 implements MigrationInterface {
    name = 'InitialMigration1751971910983'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "composantes" ("idComposante" SERIAL NOT NULL, "NomComposante" character varying(100) NOT NULL, "NomPage" character varying(100) NOT NULL, "idSite" integer, CONSTRAINT "PK_9fffd27ea912d1a6157fd94f5ac" PRIMARY KEY ("idComposante"))`);
