...
router.get('/personnalisations/:id', (req, res) => personnalisationController.selectPersonnalisationById(req, res));
router.delete('/selectbyidpersonnalisations/:id', (req, res) => personnalisationController.deletePersonnalisationById(req, res));
