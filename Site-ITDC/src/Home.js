  ...
  return (
    <div className="App font-montserrat">
      ...
      >
        ...
        <div className="z-10 flex flex-col items-center text-center gap-6 px-4 pt-24 max-w-3xl">
          <h1 className="text-white font-extrabold drop-shadow-lg text-3xl sm:text-4xl md:text-5xl leading-tight">
            ITDC <span className="text-itdc">Mada</span><br />
            <span className="text-white">Experts en solutions numériques innovantes</span>
          </h1>
          <div className="w-[150px] sm:w-[200px] h-[3px] bg-bleuIt rounded-full"></div>
          <p className="text-white font-light text-base sm:text-lg leading-relaxed">
            Depuis 2017, nous transformons le numérique et les données environnementales
            en leviers de croissance pour les entreprises à Madagascar.
          </p>
          <a
            href="tel:+261345263787"
            className="bg-bleuIt text-white flex items-center gap-2 px-6 py-2 rounded hover:shadow-[10px_11px_0_#e18728] transition-all duration-500"
          >
      ...
      <section id="About" className="bg-grisFond pt-20 pb-10 px-4 sm:px-8 md:px-16 lg:px-20">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase text-bleuIt mb-12 text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 text-center">
          <div>
            ...
            <p className="text-gray-700 text-sm mt-1">Années d'expérience</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-bleuIt">50+</h3>
            <p className="text-gray-700 text-sm mt-1">Projets réalisés</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-bleuIt">12+</h3>
            <p className="text-gray-700 text-sm mt-1">Partenaires</p>
          </div>
        </div>
      ...
      <section id="Services" className="bg-white pt-20 pb-10 px-4 sm:px-8 md:px-16 lg:px-20">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-2">
          <div className="bg-grisFond p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-700 mb-4">Solutions sur mesure pour optimiser vos processus et votre interaction client.</p>
          </div>
          <div className="bg-grisFond p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold text-bleuIt mb-2">Accompagnement Numérique</h3>
            <p className="text-gray-700 mb-4">Conseils et intégration de solutions digitales adaptées à votre activité.</p>
          </div>
          <div className="bg-grisFond p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold text-bleuIt mb-2">Développement Environnemental</h3>
            <p className="text-gray-700 mb-4">Solutions IT dédiées à la gestion et valorisation des données environnementales.</p>
          </div>
          <div className="bg-grisFond p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
            <h3 className="text-xl font-semibold text-bleuIt mb-2">Collecte et Analyse de Données</h3>
            <p className="text-gray-700 mb-4">Acquisition et traitement de données spatiales et tabulaires.</p>
          </div>
        </div>
